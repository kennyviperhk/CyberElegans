...
class CConnector
{
    ...
    public Color springColor = new Color(0, 0, 0, 0);
...
class CSpring : CConnector
{
    ...
    public CSpring(float len, float stiffness, float friction, CMassPoint p1, CMassPoint p2) : base(p1, p2)
    {
        ...
        //Set,Color,Alpha
        if ((Globals.renderSwitch & EWormParts.spring) != 0) render = ResManager.CreateObject(EWormParts.spring, Color.gray, 0.001f * Globals.scale);
