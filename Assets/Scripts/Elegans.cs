...
class Elegans
{
    ...
    public GameObject plane = GameObject.Find("Plane1");
   ...
   /* void planetransform()
    ...
    plane.transform.eulerAngles.y + 90,
    plane.transform.eulerAngles.z
        );
        plane.transform.localScale += new Vector3(1.8f, 1.8f, 1.8f);


        plane2.transform.eulerAngles = new Vector3(
        plane2.transform.eulerAngles.x,
        plane2.transform.eulerAngles.y + 90,
        plane2.transform.eulerAngles.z
        );
        plane2.transform.localScale += new Vector3(1.8f, 1.8f, 1.8f);

        plane3.transform.eulerAngles = new Vector3(
         plane3.transform.eulerAngles.x,
         plane3.transform.eulerAngles.y + 90,
        plane3.transform.eulerAngles.z
        );
        plane3.transform.localScale += new Vector3(1.8f, 1.8f, 1.8f);

        plane4.transform.eulerAngles = new Vector3(
        plane4.transform.eulerAngles.x,
        plane4.transform.eulerAngles.y + 90,
        plane4.transform.eulerAngles.z
        );
        plane4.transform.localScale += new Vector3(1.8f, 1.8f, 1.8f);

        plane5.transform.eulerAngles = new Vector3(
        plane5.transform.eulerAngles.x,
        plane5.transform.eulerAngles.y + 90,
        plane5.transform.eulerAngles.z
        );
        plane5.transform.localScale += new Vector3(1.8f, 1.8f, 1.8f);

        plane6.transform.eulerAngles = new Vector3(
        plane6.transform.eulerAngles.x,
        plane6.transform.eulerAngles.y + 90,
        plane6.transform.eulerAngles.z
        );
    ...
    public void UpdateLogic(float dt) {
        ...
        for(int i = 0; i < mMuscle.Count; ++i) {
            ...
            //    plane.transform.position = mMuscle[i].getPos();
            }
